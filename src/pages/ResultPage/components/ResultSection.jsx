    ...
    return (
        <ResultSectionContainer>
            ...
            <CharacterContainer>
                ...
                <LoginLogoutDate>
                <LoginDate>마지막 로그인 {
                    character.characterBasic.characterDateLastLogin && formatDate(new Date(character.characterBasic.characterDateLastLogin))
                }</LoginDate>
                <LogoutDate>마지막 로그아웃 {
                    character.characterBasic.characterDateLastLogout && formatDate(new Date(character.characterBasic.characterDateLastLogout))
                }
                </LogoutDate>
            </LoginLogoutDate>
            </CharacterContainer>
